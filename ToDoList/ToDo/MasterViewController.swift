...
class MasterViewController: UITableViewController, AddItemViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // UIImageViewを作成する.
        let myImageView: UIImageView = UIImageView(frame: CGRectMake(0,0,302,500))
        
        // 表示する画像を設定する.
        let myImage = UIImage(named: "logo8.png")
        
        // 画像をUIImageViewに設定する.
        myImageView.image = myImage
        
        // 画像の表示する座標を指定する.
        myImageView.layer.position = CGPoint(x: self.view.bounds.width/2, y: 251.0)
